...
(function() {
  ...
  const JDIAnalytics = {
    ...
    injectMockData: function() {
      ...
      db.calculatorData.push(
        { area: 120, location: 'base', standard: 'executivo', estimatedCost: 6600000, timestamp: now - 3600000 * 48, sessionId: 'sess_m1' },
        { area: 180, location: 'logistic', standard: 'premium', estimatedCost: 14931000, timestamp: now - 3600000 * 24, sessionId: 'sess_m4' },
        { area: 350, location: 'water', standard: 'luxo', estimatedCost: 42367000, timestamp: now - 3600000 * 10, sessionId: 'sess_m6' },
        { area: 150, location: 'base', standard: 'executivo', estimatedCost: 8250000, timestamp: now - 1500000, sessionId: 'sess_m7' }
      );
      ...
      db.leads.push(
        {
          source: 'Simulador',
          details: { nome: 'João Macaringue', email: 'joao.mac@empresa.co.mz', telefone: '+258 84 123 4567', standard: 'Padrão Executivo', area: 120, custo: '6.600.000 MT', totalCost: 6600000 },
          timestamp: now - 3600000 * 48,
          sessionId: 'sess_m1'
        },
        {
          source: 'Simulador',
          details: { nome: 'Maria Langa', email: 'maria.langa@hotmail.com', telefone: '+258 82 890 1234', standard: 'Padrão Premium', area: 180, custo: '14.931.000 MT', totalCost: 14931000 },
    ...
    function AdminDashboard() {
      ...
      const calcStats = React.useMemo(() => {
        ...
        const standardLabels = {
          executivo: 'Padrão Executivo',
          premium: 'Padrão Premium',
